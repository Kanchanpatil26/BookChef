...
<div class="main-container">
    <div class="sidebar">
        ...
        <ul class="menu">
            ...
            <li><a href="changePasswordUser.html"><i class="fas fa-check"></i>Change Password</a></li>
            <li><a href="index.html"><i class="fas fa-check"></i>Go to Home</a></li>
        </ul>
    </div>
    <div class="content">
        <div class="search-form-container">
            <form action="viewChefSpeciality.jsp" class="search-form">
                <h2>Some Special Chefs....</h2>
                <input type="text" name="ccity" placeholder="Enter the city">
                 <input type="text" name="cspeciality" placeholder="Enter the speciality you want">
                
                <input type="submit" value="Search for chefs">
            </form>
        </div>
        <table>
        <%
        try {
            ...
            if (ccity != null && cspeciality!=null) {
        %>
        <tr>
            <th>ID</th>
                    <th>Name</th>
        ...
        <%
            ...
            PreparedStatement ps = con.prepareStatement("select * from chef where ccity=? and cspeciality=?");
        ...
        <tr>
            <td><%= rs.getInt(1) %></td>
                        ...
                        <td><a href="bookingChef.jsp?id=<%=rs.getInt(1)%>">Book</a></td>
