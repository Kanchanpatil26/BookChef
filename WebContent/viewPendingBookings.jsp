...
<%@page import="com.kanchan.bookchef.Chefs" %>
...
<div class="main-container">
    <div class="sidebar">
        ...
        <ul class="menu">
            ...
            <li><a href="viewDisapprovedBookings.jsp"><i  class="fas fa-check"></i>View Disapproved Bookings</a></li>
            <li><a href="changePassword.html"><i  class="fas fa-check"></i>Change Password</a></li>
            <li><a href="index.html"><i class= class="fas fa-check"></i>Go to Home</a></li>
                ...
                try {
                 ...
                 %>
                    <tr>
                        ...
                        <td><a href="approveBooking.jsp?id=<%=rs.getInt(1)%>">Approve</a></td>
                        <td><a href="disapproveBooking.jsp?id=<%=rs.getInt(1)%>">Disapprove</a></td>
